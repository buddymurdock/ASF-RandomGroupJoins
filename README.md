...
| `RandomGroupJoinsGroupIDs` | `ulong[]` (или строки с числом) | `[]` | Пул Steam-групп (64-битные SteamID, тип "clan"), из которого боты будут случайно вступать. Без этого списка плагин ничего не делает и один раз пишет предупреждение в лог. |
